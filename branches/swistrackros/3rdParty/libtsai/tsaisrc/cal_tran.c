...
*
* April 1997 Thierry Zimerman IMT/DMT/EPFL
*	Aded the cal_tran.h header file 
*                                                                               *
\*******************************************************************************/
#include "libtsai.h"
...
void undistorted_to_distorted_sensor_coord (calibration_constants cc,
	double Xu, double Yu, double *Xd, double *Yd)
{
...
void distorted_to_undistorted_sensor_coord (calibration_constants cc,
  double Xd, double Yd, double* Xu, double* Yu)
{
...
void      undistorted_to_distorted_image_coord (Xfu, Yfu, Xfd, Yfd)
    double    Xfu,
             ...
             *Yfd;
*/
void undistorted_to_distorted_image_coord (calibration_constants cc, camera_parameters cp,
		double Xfu, double Yfu, double* Xfd, double* Yfd)
{
    double    Xu,
              Yu,
              Xd,
    ...
    undistorted_to_distorted_sensor_coord (cc, Xu, Yu, &Xd, &Yd);
...
void      distorted_to_undistorted_image_coord (Xfd, Yfd, Xfu, Yfu)
    double    Xfd,
             ...
             *Yfu;
*/
void distorted_to_undistorted_image_coord (calibration_constants cc, camera_parameters cp,
	double Xfd, double Yfd, double* Xfu, double* Yfu)
{
    double    Xd,
              Yd,
              Xu,
    ...
    distorted_to_undistorted_sensor_coord (cc,Xd, Yd, &Xu, &Yu);
...
void      world_coord_to_image_coord (xw, yw, zw, Xf, Yf)
    double    xw,
             ...
             *Yf;
*/
void world_coord_to_image_coord (calibration_constants cc, camera_parameters cp,
		double xw, double yw, double zw, double* Xf, double *Yf)
{
    double    xc,
              yc,
              zc,
...
void      image_coord_to_world_coord (Xfd, Yfd, zw, xw, yw)
    double    Xfd,
             ...
             *yw;
*/
void image_coord_to_world_coord (calibration_constants cc, camera_parameters cp,
		double Xfd, double Yfd, double zw, double* xw, double* yw)
{
    double    Xd,
              Yd,
              Xu,
...
void      world_coord_to_camera_coord (xw, yw, zw, xc, yc, zc)
    double    xw,
        ...
        *zc;
*/
void world_coord_to_camera_coord (calibration_constants cc, double xw, double yw, double zw, double *xc, double* yc, double* zc)
{
    *xc = cc.r1 * xw + cc.r2 * yw + cc.r3 * zw + cc.Tx;
    *yc = cc.r4 * xw + cc.r5 * yw + cc.r6 * zw + cc.Ty;
    *zc = cc.r7 * xw + cc.r8 * yw + cc.r9 * zw + cc.Tz;
...
void camera_coord_to_world_coord (calibration_constants cc,
		double xc, double yc, double zc, double* xw, double* yw, double* zw)
{

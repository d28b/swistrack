...
#define THISCLASS ComponentChannelCalculationColorToGray

#include <opencv2/core.hpp>
#include "DisplayEditor.h"
#include "ImageTools.h"

THISCLASS::ComponentChannelCalculationColorToGray(SwisTrackCore * stc):
	Component(stc, wxT("ChannelCalculationColorToGray")),
	mContext(NULL),
...
THISCLASS::~ComponentChannelCalculationColorToGray() {

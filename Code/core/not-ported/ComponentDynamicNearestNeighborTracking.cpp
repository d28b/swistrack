...
*/
double THISCLASS::GetCost(const Track & track, cv::Point2f p) {
	if (track.trajectory.size() == 0) return -1;
...
void THISCLASS::IntegrateHistogram(cv::Mat dest, cv::Mat newSample) {

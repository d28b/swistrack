...
namespace Expression {
	...
	protected:
		cv::Mat Calculate(cv::Mat left, cv::Mat right) { return left + right; }
		cv::Mat Calculate(cv::Mat left, double right) { return left + right; }
		cv::Mat Calculate(double left, cv::Mat right) { return left + right; }
		double Calculate(double left, double right) { return left + right; }
	};
	...
	protected:
		cv::Mat Calculate(cv::Mat left, cv::Mat right) { return smallerThan(left, right); }
		cv::Mat Calculate(cv::Mat left, double right) { return smallerThan(left, right); }
		cv::Mat Calculate(double left, cv::Mat right) { return smallerThan(left, right); }
		double Calculate(double left, double right) { return smallerThan(left, right); }
	};
	...
	protected:
		cv::Mat Calculate(cv::Mat left, cv::Mat right) { return biggerThan(left, right); }
		cv::Mat Calculate(cv::Mat left, double right) { return biggerThan(left, right); }
		cv::Mat Calculate(double left, cv::Mat right) { return biggerThan(left, right); }
		double Calculate(double left, double right) { return biggerThan(left, right); }
	};
	...
	protected:
		cv::Mat Calculate(cv::Mat left, cv::Mat right) { return cv::min(left, right); }
		cv::Mat Calculate(cv::Mat left, double right) { return cv::min(left, right); }
		cv::Mat Calculate(double left, cv::Mat right) { return cv::min(left, right); }
		double Calculate(double left, double right) { return left < right ? left : right; }
	};
	...
	protected:
		cv::Mat Calculate(cv::Mat left, cv::Mat right) { return cv::max(left, right); }
		cv::Mat Calculate(cv::Mat left, double right) { return cv::max(left, right); }
		cv::Mat Calculate(double left, cv::Mat right) { return cv::max(left, right); }
		double Calculate(double left, double right) { return left > right ? left : right; }
	};
	...
	protected:
		cv::Mat Calculate(cv::Mat left, cv::Mat right) { return left & right; }
		cv::Mat Calculate(cv::Mat left, unsigned char right) { return left & right; }
		cv::Mat Calculate(unsigned char left, cv::Mat right) { return left & right; }
		int Calculate(unsigned char left, unsigned char right) { return left & right; }
	};
	...
	protected:
		void Calculate(cv::Mat value, cv::Mat & result) { cv::sqrt(value, result); }
		double Calculate(double value) { return sqrt(value); }
	};
	...
	protected:
		void Calculate(cv::Mat value, cv::Mat & result) { cv::log(value, result); }
		double Calculate(double value) { return log(value); }
	};
	...
	protected:
		void Calculate(cv::Mat value, cv::Mat & result) { cv::exp(value, result); }
		double Calculate(double value) { return exp(value); }
	};
	...
	protected:
		double Calculate(cv::Mat value) { return cv::sum(value).val[0]; }
		double Calculate(double value) { return value; }
	};
	...
	protected:
		double Calculate(cv::Mat value) { return cv::mean(value).val[0]; }
		double Calculate(double value) { return value; }
	};

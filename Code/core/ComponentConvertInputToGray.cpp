...
#define THISCLASS ComponentConvertInputToGray

#include "DisplayEditor.h"

THISCLASS::ComponentConvertInputToGray(SwisTrackCore * stc):
	Component(stc, wxT("ConvertInputToGray")),
	mChannel(0),
...
THISCLASS::~ComponentConvertInputToGray() {
}

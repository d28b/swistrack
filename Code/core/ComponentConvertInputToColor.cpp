...
#define THISCLASS ComponentConvertInputToColor

#include "DisplayEditor.h"

THISCLASS::ComponentConvertInputToColor(SwisTrackCore * stc):
	Component(stc, wxT("ConvertInputToColor")),
...
THISCLASS::~ComponentConvertInputToColor() {
}

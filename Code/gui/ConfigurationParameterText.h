#ifndef HEADER_ConfigurationParameterText
#define HEADER_ConfigurationParameterText
...
class ConfigurationParameterText;

#include "ConfigurationParameter.h"

class ConfigurationParameterText: public ConfigurationParameter {

public:
	//! Constructor.
	ConfigurationParameterText(wxWindow * parent);
	//! Destructor.
	~ConfigurationParameterText();

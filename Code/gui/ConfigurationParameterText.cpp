...
#define THISCLASS ConfigurationParameterText
...
THISCLASS::ConfigurationParameterText(wxWindow * parent):
	ConfigurationParameter(parent),
	mValueDefault(wxT("")) {

}

THISCLASS::~ConfigurationParameterText() {
}
...
void THISCLASS::OnInitialize(ConfigurationXML * config, ErrorList * errorlist) {
	...
	mTextCtrl = new wxTextCtrl(this, wxID_ANY, wxT(""), wxDefaultPosition, wxSize(scParameterWidth, 100), wxTE_PROCESS_ENTER | wxTE_MULTILINE);
